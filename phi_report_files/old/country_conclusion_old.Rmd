...
1. Information products for acute public health **events** in the **`r selected.region` Region only** in the period `r format(as.Date(as.yearmon(report.month)) %m-% months(6), '%b %Y')` – `r format(as.Date(as.yearmon(report.month)), '%b %Y')` were related to **(EDIT) XXX**.
