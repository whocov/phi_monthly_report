...
line_data <- data.frame(
  ...
  group = factor(rep(c("National 7-day cutoff", "Regional 14-day cutoff", "Global 21-day cutoff"), each = 2),  levels = c("National 7-day cutoff", "Regional 14-day cutoff", "Global 21-day cutoff")))
